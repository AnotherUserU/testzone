...
// ... Will be fleshed out by creating buildCard function which returns a DOM node
...
function buildCard(team, isReadOnly) {
  ...
  let html = `
    ...
    <div class="card-head">
      ...
      <div class="card-tag" ${!isReadOnly ? 'contenteditable="true"' : ''}>${team.tag}</div>
      <div class="card-title" ${!isReadOnly ? 'contenteditable="true"' : ''}>${team.title}</div>
      <div class="card-desc" ${!isReadOnly ? 'contenteditable="true"' : ''}>${team.desc}</div>
      ...
      <div class="card-members">
        ${team.members.map((m, idx) => `
          <div class="mem-row" data-index="${idx}">
            ...
            <div class="mem-info">
              <span class="mem-name" ${!isReadOnly ? 'contenteditable="true"' : ''}>${m.name}</span>
              <span class="mem-bind" ${!isReadOnly ? 'contenteditable="true"' : ''}>${m.bind}</span>
            </div>
